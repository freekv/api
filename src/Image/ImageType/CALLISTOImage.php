...
/**
 * Image_ImageType_CALLISTOImage class definition
 ...
 * @link     http://launchpad.net/helioviewer.org
 */
class Image_ImageType_CALLISTOImage extends Image_HelioviewerImage
{
    /**
     * Creates a new CALLISTOImage
     * 
    ...
    {
        $colorTable = HV_ROOT_DIR . "/api/resources/images/color-tables/SDO_CALLISTO_$meas.png";
    ...
    {
        return "CALLISTO $this->measurement\n";
    }
}
