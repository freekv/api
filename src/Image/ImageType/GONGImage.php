...
/**
 * Image_ImageType_GONGHALPHAImage class definition
...
class Image_ImageType_GONGImage extends Image_HelioviewerImage
{
    ...
    {
        //$colorTable = HV_ROOT_DIR . "/api/resources/images/color-tables/Gray.png";
    ...
    {
        return "GONGHALPHA $this->measurement\n";
    }
}
